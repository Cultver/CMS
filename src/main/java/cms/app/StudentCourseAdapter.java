...
public class StudentCourseAdapter extends ArrayAdapter<CourseInfo> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView textViewId = v.findViewById(R.id.listview_student_course_id);
        TextView textViewName = v.findViewById(R.id.listview_student_course_name);
        TextView textViewType = v.findViewById(R.id.listview_student_course_type);
