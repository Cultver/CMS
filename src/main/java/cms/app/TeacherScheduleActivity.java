...
public class TeacherScheduleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String retmsg = CMSClient.sendAndReceive("query_course\n" + GlobalConfig.currentUser);
        Gson gson = new Gson();
        ...
        StudentSchedulesAdapter adp = new StudentSchedulesAdapter(TeacherScheduleActivity.this, R.layout.list_item_student_schedules, schedules);
